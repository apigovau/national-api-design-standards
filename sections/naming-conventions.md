...
- Query parameters values **MUST** be percent-encoded, and **SHOULD** for compatability reasons be restricted to the AWS supported query paramter regex ^[a-zA-Z0-9._$-]+$
