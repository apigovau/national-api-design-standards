...
-	Transmission of any payload, request or response, containing data classified as having a high business impact level (Commonwealth classification of ‘PROTECTED’) or above MUST be accompanied by an ‘x-protective-marking’ HTTP header. 
-	Data classified as having a ‘low to medium’ business impact or above SHOULD be accompanied by an ‘x-protective-marking’ HTTP header, wherever technically feasible. 
